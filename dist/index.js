...
/***/ function(module, exports, __webpack_require__) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var extractBindings = __webpack_require__(47)
		var stringify = __webpack_require__(48)
		var parseExpr = __webpack_require__(49)
		var decode = __webpack_require__(16)
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		//缓存求值函数，以便多次利用
		var evaluatorPool = __webpack_require__(50)
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=ms-tabs><ul class=ms-tabs-buttons><li class=ms-tabs-button :for=\"($index,el) in @triggers\" :class=\"[$index === @selectedIndex && 'active']\" :click=@cbProxy($event,$index)>{{el}}</li></ul><div class=ms-tabs-panels><div class=ms-tabs-panel :for=\"($index, el) in @panels\" :visible=\"$index === @selectedIndex\" :html=el></div></div></div>"
